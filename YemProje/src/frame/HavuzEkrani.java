...
public class HavuzEkrani extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        aryator_alani = new javax.swing.JTextField();
        ...
        table_alani.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Havuz No", "Yem Kategori", "Yem Miktar", "Balik Cinsi", "Balık Sayısı", "Aryator Idl"
            }
        ) {
        ...
        jLabel5.setText("Aryator Sayısı");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(aryator_alani, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void table_alaniMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_alaniMouseClicked
        ...
        aryator_alani.setText(model.getValueAt(selectedRow, 6).toString());
    ...
    private void ekle_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekle_buttonActionPerformed
        ...
        String aryator = aryator_alani.getText();

        boolean kontrol = havuzDao.kontrolYap(havuz_no,balikCins,balikSayisi);
        
        if (havuz_no.equals("") || kategori.equals("") || miktar.equals("") || balikCins.equals("") || balikSayisi.equals("") || aryator.equals("")) {
            ...
            havuzDao.ekleHavuz(havuz_no, kategori, miktar, balikCins, balikSayisi, aryator);
    ...
    private void guncelle_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelle_buttonActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            if (true) {
                havuzDao.guncelleHavuz(id, havuz_no, kategori, miktar, balikCins, balikSayisi, aryator);
                clearForm();
    ...
    private javax.swing.JTextField aryator_alani;
    ...
    private void havuzGoruntule() {
        ...
        if (havuzs != null) {
            for (Havuz havuz : havuzs) {
                Object[] eklenecek = {
                    havuz.getId(), havuz.getHavuzNo(), havuz.getYemKategori(), havuz.getYemMiktar(), havuz.getBalikCinsi(), havuz.getHavuzdakiBalikSayisi(), havuz.getAryatorSayisi()
                };
