...
public class Veterinary implements Serializable {
    ...
    //@OneToMany(cascade = {CascadeType.MERGE, CascadeType.REFRESH}, mappedBy = "veterinary")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Veterinary)) {
            return false;
        }
        Veterinary other = (Veterinary) object;
    ...
    public String toString() {
        return "dVeterinerlik.entity.Veterinary[ id=" + id + " ]";
    }
